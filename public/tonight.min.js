(function(){var
offset=(new Date()).getTimezoneOffset()/-60*1000,timestamps=document.getElementsByClassName("timestamp"),i,timestamp,date,label,selectOutField
...
selectOutField=function(){document.querySelector(".out form.add input").select()}
